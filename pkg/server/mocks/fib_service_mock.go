...
func (m *MockFibService) FibSequence(ctx context.Context, first, last int) ([]service.FibNumber, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FibSequence", ctx, first, last)
...
func (mr *MockFibServiceMockRecorder) FibSequence(ctx, first, last interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FibSequence", reflect.TypeOf((*MockFibService)(nil).FibSequence), ctx, first, last)
}
