...
type FibonacciClient interface {
	GetFibonacci(ctx context.Context, in *FibonacciSequenceRequest, opts ...grpc.CallOption) (*FibonacciSequenceResponse, error)
}
...
func (c *fibonacciClient) GetFibonacci(ctx context.Context, in *FibonacciSequenceRequest, opts ...grpc.CallOption) (*FibonacciSequenceResponse, error) {
	out := new(FibonacciSequenceResponse)
	err := c.cc.Invoke(ctx, "/fibonacci.Fibonacci/GetFibonacci", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	GetFibonacci(context.Context, *FibonacciSequenceRequest) (*FibonacciSequenceResponse, error)
...
func (UnimplementedFibonacciServer) GetFibonacci(context.Context, *FibonacciSequenceRequest) (*FibonacciSequenceResponse, error) {
...
func _Fibonacci_GetFibonacci_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibonacci.Fibonacci/GetFibonacci",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).GetFibonacci(ctx, req.(*FibonacciSequenceRequest))
	}
